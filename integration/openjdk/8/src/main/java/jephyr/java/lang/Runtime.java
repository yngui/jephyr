...
public class Runtime {
    ...
    private final Map<Thread, java.lang.Thread> hooks = new IdentityHashMap<>();
    ...
    public void addShutdownHook(Thread hook) {
        java.lang.Thread hook1 = new java.lang.Thread() {
            @Override
            public void run() {
                hook.start();
                try {
        ...
        synchronized (hooks) {
            hooks.put(hook, hook1);
        }
        java.lang.Runtime.getRuntime().addShutdownHook(hook1);
    }
    ...
    public boolean removeShutdownHook(Thread hook) {
        java.lang.Thread hook1;
        synchronized (hooks) {
            hook1 = hooks.remove(hook);
        }
        return hook1 != null && java.lang.Runtime.getRuntime().removeShutdownHook(hook1);
    }
    ...
    public Process exec(String command, String[] envp) throws IOException {
        return java.lang.Runtime.getRuntime().exec(command, envp);
    }
    ...
    public Process exec(String command, String[] envp, File dir)
        throws IOException {
        return java.lang.Runtime.getRuntime().exec(command, envp, dir);
    }
    ...
    public Process exec(String cmdarray[]) throws IOException {
        return java.lang.Runtime.getRuntime().exec(cmdarray);
    }
    ...
    public Process exec(String[] cmdarray, String[] envp) throws IOException {
        return java.lang.Runtime.getRuntime().exec(cmdarray, envp);
    }
