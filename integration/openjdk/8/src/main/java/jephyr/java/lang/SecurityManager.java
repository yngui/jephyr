...
class SecurityManager {
    ...
    private final JavaSecurityManager securityManager = new JavaSecurityManager();
    ...
    {
        return securityManager.currentClassLoader();
    }
    ...
    protected Class<?> currentLoadedClass() {
        return securityManager.currentLoadedClass();
    }
    ...
    protected int classDepth(String name) {
        return securityManager.classDepth(name);
    }
    ...
    {
        return securityManager.classLoaderDepth();
    }
    ...
    protected boolean inClass(String name) {
        return securityManager.inClass(name);
    }
    ...
    protected boolean inClassLoader() {
        return securityManager.inClassLoader();
    }
    ...
    private static final class JavaSecurityManager extends java.lang.SecurityManager {
