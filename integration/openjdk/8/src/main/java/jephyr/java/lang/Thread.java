...
class Thread implements Runnable {
   ...
   /**
    ...
    public final void resume() {
        checkAccess();
        java.lang.Thread.currentThread().resume();
    }
    ...
    public int countStackFrames() {
        return java.lang.Thread.currentThread().countStackFrames();
    }
     ...
     */
    public final synchronized boolean isDaemon() {
        return daemon;
    }
    ...
    private static final class ThreadAccessImpl implements ThreadAccess<Thread, Interruptible> {
        ...
        @Override
        public ThreadImpl getImpl(Thread thread) {
            return thread.impl;
        }
