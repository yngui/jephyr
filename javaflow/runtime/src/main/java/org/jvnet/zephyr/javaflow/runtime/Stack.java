...
public class Stack implements Serializable {
    ...
    private static final int[] EMPTY_ISTACK = new int[0];
    private static final long[] EMPTY_LSTACK = new long[0];
    private static final double[] EMPTY_DSTACK = new double[0];
    private static final float[] EMPTY_FSTACK = new float[0];
    private static final Object[] EMPTY_OSTACK = new Object[0];
    private static final Object[] EMPTY_RSTACK = new Object[0];
