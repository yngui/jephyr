...
package org.jvnet.zephyr.jcl.impl.util.concurrent.locks;
...
public abstract class AbstractQueuedLongSynchronizer
    ...
    */
     ...
     */
    protected static final long spinForTimeoutThreshold = 1000L;
     ...
     */
    protected final boolean acquireQueued(final Node node, long arg) {
        boolean failed = true;
        try {
     ...
     */
    protected final boolean isOnSyncQueue(Node node) {
     ...
     */
    protected final boolean transferForSignal(Node node) {
        /*
     ...
     */
    protected final boolean transferAfterCancelledWait(Node node) {
        if (compareAndSetWaitStatus(node, Node.CONDITION, 0)) {
            enq(node);
            return true;
        }
     ...
     */
    protected final long fullyRelease(Node node) {
        boolean failed = true;
        try {
