...
class Thread implements Runnable {
    ...
    public static Thread currentThread() {
        return ThreadImpl.getCurrentThread();
    }
    ...
    public static void sleep(long millis) throws InterruptedException {
        currentThread().impl.sleep(millis);
    }
    ...
    throws InterruptedException {
        currentThread().impl.sleep(millis, nanos);
    }
    ...
    public static void setDefaultUncaughtExceptionHandler(UncaughtExceptionHandler eh) {
        ThreadImpl.setDefaultUncaughtExceptionHandler(eh);
    }
    ...
    public static UncaughtExceptionHandler getDefaultUncaughtExceptionHandler(){
        return ThreadImpl.getDefaultUncaughtExceptionHandler();
    }
